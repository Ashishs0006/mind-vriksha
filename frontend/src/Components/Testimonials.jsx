...
const Testimonials = () => {
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 640, // sm: Small mobile landscape
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
        }
      ...
      {
        breakpoint: 1024, // lg: Small laptops
        settings: {
          slidesToShow: 2,
          slidesToScroll: 1,
        }
      ...
      {
        breakpoint: 1280, // xl: Large laptops
        settings: {
          slidesToShow: 3,
          slidesToScroll: 1,
        }
      ...
      {
        breakpoint: 1536, // 2xl: Large desktops
        settings: {
          slidesToShow: 3,
          slidesToScroll: 1,
        }
      ...
      {
        breakpoint: 1920, // 3xl: Large desktops (Mac M3, etc.)
        settings: {
          slidesToShow: 3,
          slidesToScroll: 1,
          dots: true
      ...
      {
        breakpoint: 2560, // 4xl: Ultra-wide displays
        settings: {
          slidesToShow: 3,
          slidesToScroll: 1,
          dots: true
