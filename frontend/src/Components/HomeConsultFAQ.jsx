...
const ConsultationSection = () => {
    return (
        <section 
  id='Consultation' 
  className="min-h-screen py-6 md:py-12 bg-[#f0f9eb] font-['Inter'] flex items-center justify-center"
>
  <div className="w-full max-w-6xl mx-auto px-2 sm:px-4">
    <div className="flex flex-col lg:flex-row items-stretch h-full gap-8">

      {/* Left Side: Consultation Form */}
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-start items-center p-6 md:p-10 rounded-xl shadow-2xl">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center p-6 md:p-10 rounded-xl shadow-2xl">
